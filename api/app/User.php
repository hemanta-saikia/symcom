...
class User extends Model implements AuthenticatableContract, AuthorizableContract
{
     ...
     */
    protected $fillable = [
        'username', 'user_type', 'salutation', 'first_name', 'last_name', 'email', 'phone', 'password', 'active', 'company', 'ip_address', 'last_login_at', 'current_login_at', 'created_at', 'updated_at'
    ];
